...
def seed_services():
    ...
    for service in services_data:
        cur.execute(
            ...
            (service["name"], service["price"], service["desc"]),
        )
        cur.execute(
            "UPDATE services SET description = ?, price = ? WHERE name = ?",
            (service["desc"], service["price"], service["name"]),
        )
