...
def seed_services():
    ...
    services_data = [
        (
            "Эссе (Меткий выстрел)",
            4500,
            "⏱ <b>Срок:</b> 1-3 дня.\n🎒 <b>Нужно:</b> Тема, методичка.\n\n<i>Суть:</i> Бьем точно в цель.",
        ),
        (
            "Курсовая (Партия в покер)",
            15000,
            "⏱ <b>Срок:</b> 5-7 дней.\n🎒 <b>Нужно:</b> Тема, план.\n\n<i>Суть:</i> Соберем Роял Флеш.",
        ),
        (
            "Диплом (Золотая жила)",
            35000,
            "⏱ <b>Срок:</b> 14-21 день.\n🎒 <b>Нужно:</b> Тема, план.\n\n<i>Суть:</i> Полное сопровождение.",
        ),
        (
            "Магистерская (Собственное Ранчо)",
            55000,
            "⏱ <b>Срок:</b> 20-30 дней.\n🎒 <b>Нужно:</b> Данные.\n\n<i>Суть:</i> Фундаментальный труд.",
        ),
        (
            "Отчет по практике (Верный мустанг)",
            12000,
            "⏱ <b>Срок:</b> 3-5 дней.\n🎒 <b>Нужно:</b> База практики.\n\n<i>Суть:</i> Вывезет к зачету.",
        ),
        (
            "Экзамен (Дикое Родео)",
            20000,
            "⏱ <b>Срок:</b> Real-time.\n🎒 <b>Нужно:</b> Дата и время.\n\n<i>Суть:</i> Мы страхуем, ты сдаешь.",
        ),
        (
            "Презентация (Карта сокровищ)",
            2500,
            "⏱ <b>Срок:</b> 1-2 дня.\n🎒 <b>Нужно:</b> Текст.\n\n<i>Суть:</i> Яркие слайды.",
        ),
        (
            "Речь (Тост за удачу)",
            2500,
            "⏱ <b>Срок:</b> 1 день.\n🎒 <b>Нужно:</b> Работа.\n\n<i>Суть:</i> Защита на отлично.",
        ),
        (
            "VIP (Ключ от города)",
            5000,
            "⏱ <b>Срок:</b> Индивидуально.\n<i>Суть:</i> Приоритет и лучшие мастера.",
        ),
    ]
